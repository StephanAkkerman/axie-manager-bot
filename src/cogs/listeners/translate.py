...
class Translate(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        # Ignore bot messages 
        bot_id = config["DEBUG"]["BOT_ID"] if len(sys.argv) > 1 and sys.argv[1] == "-test" else config["DISCORD"]["BOT_ID"]
        ...
        if message.author.id != bot_id:
            ...
            if translated.lang == config['LISTENERS']['TRANSLATE']['LANGUAGE'] and translated.confidence > 0.2:
